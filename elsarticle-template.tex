...
Given the northern and southern Caddo communities of practice identified in the network analysis \citep{RN8031}, and the material culture distinctions that have been reported between these areas to date, one can speculate that regional distinctions in Perdiz arrow point shape might be interpreted as each region expressing extra-regional interaction(s) in slightly different ways. It could also reflect regional differences at the community and subcommunity levels in design perceptions of what Perdiz points were and how those design constraints were predicated and imposed through different raw material choices.
