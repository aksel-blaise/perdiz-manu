...
Recent studies of Caddo bottle and biface morphology have revealed a previously unrecognised north-south shape boundary, as well as a geogarphic shape difference in Gahagan bifaces found in the southern Caddo area and central Texas \citep{RN7162,RN5693,RN7927,RN8074,RN8158,RN8370,RN8322,RN8312}. This preliminary effort expands upon that research program to include arrow points, is the first attempt to aggregate and analyse Perdiz arrow point shapes at a macro scale in the southern Caddo area, and resulted in the identification of significant shape differences between temporal components, raw materials, and burial contexts. The analysis confirms that Perdiz arrow point morphology is labile, and that while some of the diagnostic shape differences are distinct, others are more nuanced. 
...
Data and analysis code associated with the geometric morphometric components of this study can be accessed through the \href{https://github.com/aksel-blaise/perdiz}{GitHub repository}, which is digitally curated on the Open Science Framework \href{https://osf.io/dej74/}{DOI 10.17605/OSF.IO/DEJ74}, where additional data associated with the Chi-squared analysis is also provided.
